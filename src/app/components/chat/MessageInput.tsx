              ...
              `}
                    ...
                    <div className="flex items-center mt-3 gap-3">
                        <div className="relative">
                            <div
                                className={`flex items-center min-h-fit border ${!currentCompany?.name ? "border-dashed border-gray-300 text-gray-400" : "border-gray-200 bg-gray-50 text-gray-700"} rounded-lg px-2.5 py-1.5 cursor-default text-sm h-9`}
                            >
                                {!currentCompany?.name ? (
