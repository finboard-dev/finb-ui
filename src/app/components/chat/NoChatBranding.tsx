        ...
        <div className="flex flex-col w-full">
          <section className="flex flex-col items-center">
            ...
            <div className="w-full max-w-3xl ">
              <MessageInput showBorder={false} placeholder={messageInputPlaceholder} />
            </div>
            <div className="flex gap-3">
              {cardData.map((card, i) => (
                  <div key={i} className="flex items-center border border-primary rounded-md px-2 py-2 cursor-pointer">
          ...
          <section className="flex flex-col items-center pb-24">
            <div className="flex flex-col w-5xl">
              <div className="pt-16">
                <h1 className="text-2xl font-semibold text-left text-primary">Explore</h1>
              ...
              <div className="pt-8 grid grid-cols-3 gap-4">
                {cardImages.map((card, i) => (
                    <Image key={i} src={card || "/placeholder.svg"} alt={`Card ${i + 1}`} className="w-full h-auto" />
                ))}
              </div>
            </div>
          </section>
