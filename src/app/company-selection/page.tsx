...
const CompanySelectionPage = () => {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to connect to company"
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="w-full max-w-2xl rounded-lg border border-gray-200 p-8">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 py-12">
            ...
            <p className="text-gray-500">
              You don't have any companies in {selectedOrganization.name}'s
              organisation
            </p>
            <button
          ...
          {companies.map((company) => (
            <div
              ...
              className={`relative flex cursor-pointer items-center gap-3 rounded-md border ${
                !company.isActive ? "opacity-50 cursor-not-allowed" : ""
              } ${
